...
describe BankAccount do
  ...
  it "can make deposits" do
    ...
    it "can make a withdrawals" do
       ...
       it "can transfer funds to another another account" do
    ...
    it "allow the bank to change the opening minimum balance" do
        BankAccount.minimum_balnce(250)
...
#        expect { BankAccount.new(300, "Bridget")}.to_not raise_error(ArgumentError)
  ...
  it "allows the bank to change the minimum balance"
end

# spec/bank_account_spec